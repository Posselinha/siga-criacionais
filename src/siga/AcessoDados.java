 ...
 *
 * PROBLEMA 1 — mistura de fornecedores (falta Abstract Factory): o método
 * conectar escolhe conexão e comando por condicionais e "new" separados, sem
 * nada que garanta que ambos sejam do MESMO fornecedor. É possível, por engano,
 * abrir uma conexão MySQL e criar um comando PostgreSQL — uma combinação que
 ...
 *
 * Tarefa: - Etapa 2: criar um Abstract Factory (ex.: FabricaBanco, com
 * FabricaMySQL e FabricaPostgreSQL) que produza famílias coerentes de Conexao e
 * Comando. - Etapa 3: criar um Builder para a configuração da consulta
